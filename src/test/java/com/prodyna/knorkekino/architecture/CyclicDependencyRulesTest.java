...
public class CyclicDependencyRulesTest {
    ...
    @ArchTest
    static final ArchRule no_cycles_by_constructor_calls_between_slices = slices()
    ...
    @ArchTest
    static final ArchRule no_cycles_by_inheritance_between_slices = slices()
    ...
    @ArchTest
    static final ArchRule no_cycles_by_field_access_between_slices = slices()
    ...
    @ArchTest
    static final ArchRule no_cycles_by_member_dependencies_between_slices = slices()
    ...
    @ArchTest
    static final ArchRule no_cycles_in_simple_scenario = slices()
    ...
    @ArchTest
    static final ArchRule no_cycles_in_complex_scenario = slices()
    ...
    @ArchTest
    static final ArchRule no_cycles_in_complex_scenario_with_custom_ignore = slices()
        .matching("..(complexcycles).(*)..")
        .namingSlices("$2 of $1")
    ...
    @ArchTest
    static final ArchRule no_cycles_in_freely_customized_slices = slices()
        .assignedFrom(inComplexSliceOneOrTwo())
        .namingSlices("$1[$2]")
        .should()
        .beFreeOfCycles();
